defmodule Matches.Auth do
    ...
    alias Matches.Helpers.MapHelper
    
    @app_secret_key Application.get_env(:matches, :app_secret_key)
    @jwt_validity Application.get_env(:matches, :jwt_validity)
