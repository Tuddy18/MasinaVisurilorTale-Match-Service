...
#      {ok, myapp_db} = MyXQL.start_link(username: "root", hostname: "localhost")
#      MyXQL.query!(myapp_db, "CREATE DATABASE IF NOT EXISTS #{db_name}")
#      Logger.log(:info, "Created Database #{db_name}")
#
##    # Creating tables
##    tables
##    |> MapSet.new
###    |> MapSet.difference() # Missing tables
##    |> Enum.map(
##          MyXQL.query!(myapp_db, "CREATE TABLE posts IF NOT EXISTS (id serial primary key, title text)")
##       )
#  end
#
#  @doc "
